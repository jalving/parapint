...
class DynamicSchwarzInteriorPointInterface(BaseInteriorPointInterface, metaclass=ABCMeta):
    """
    ...
    favor the MPIDynamicSchwarzComplementInteriorPointInterface class because it supports
    ...
    overlap: int
        The number of time blocks to apply overlap
    """
    def __init__(self, start_t: float, end_t: float, num_time_blocks: int, num_partitions: int, overlap: int):
        """
        ...
        self._num_partitions:int = num_partitions  #partitions are overlaps
        self._num_states: Optional[int] = None

        #Each nlp corresponds to a timeblock
        ...
        self._link_matrices: Dict[int, coo_matrix] = dict()     # coupling constraints will be added to

        self._overlap_matrices: Dict[int,coo_matrix]
    ...
    def _build_link_forward_matrix(self, nlp, ndx, end_states):
        ...
        ndx: int
        end_states: list of pyomo.core.base.var._VarData
