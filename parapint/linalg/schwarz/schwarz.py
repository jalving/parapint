...
class SchwarzLinearSolver(LinearSolverInterface):
    """
    Solve the system Ax = b using an iterative linear solver
    """
    def __init__(self, subproblem_solvers: Dict[int, LinearSolverInterface],
        ...
        self.schur_complement_solver: LinearSolverInterface = schwarz_solver #Richardson iteration?
        self.dim = 0
        self.block_dim = 0
